...
function Sidebar({ setInfoBarData, infoBarData }) {
  ...
  useEffect(() => {
    ...
    store?.otherData?.isMobile &&
      _otherData.setOtherData({ sidebarClosed: true });
  }, [_location]);

  return (
    <ProSidebar
      className="sidebarContainer"
      collapsed={store?.otherData?.sidebarClosed}
    >
      <SidebarHeader>
        <Menu iconShape="round">
          <MenuItem icon={<AiOutlinePlus />} active={false}>
            Add New <Link to="/dashboard/uploadNew" />
          </MenuItem>
        </Menu>
      </SidebarHeader>
      <Menu iconShape="round">
        ...
        >
          API Key <Link to="apikey" />
        </MenuItem>
        <MenuItem
          icon={<BsCollection />}
          active={currentPage === "/dashboard/collection" ? true : false}
        >
        ...
        <MenuItem
          ...
          active={currentPage === "/dashboard/gateway" ? true : false}
        >
      ...
      <SidebarFooter>
        <Menu iconShape="round">
          <MenuItem
            icon={<AiOutlinePlus />}
            active={currentPage === "/dashboard/topup" ? true : false}
          >
            <p>
              <small>
                {bytesToString(
                  userBalance["dataLimit"] - userBalance["dataUsed"]
                )}{" "}
                Left{" "}
              </small>
              <br />
